...
exports.makeKeys = function() {
  ...
  // let allKeys = [config.config.dataColumnOrder, _.map(exports.data, _.keys)];
  ...
  // console.log("keys without config:");
  // console.log(exports.keys);
  // exports.keys = _.uniq(_.flatten(config.config.dataColumnOrder, exports.keys));
  // console.log("keys after adding config:");
  // console.log(exports.keys);
};
...
// Custom cell writer for dynatable, to handle missing data.
function customAttributeWriter(record) {
  // console.log(column + ":" + record[column]);
...
exports.displayData = function() {
  ...
  $("#data-display").html("")
    ...
    .ready(() => {
      ...
      $table.bind("dynatable:init", (e, dynatable) => {
