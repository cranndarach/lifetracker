...
exports.toCSV = function() {
  ...
  //   .then((csvstring) => {
  //     return new Promise((resolve, reject) => {
  //       resolve([saveDialog(opts, (filename) => {
  //         // return new Promise((resolve, reject) => {
  //         // resolve(filename);
  //           return filename;
  //       }), csvstring]);
  //     });
  //   })
  //   .spread((filename, csvstring) => {
  //     return writefile(filename, csvstring, (err) => {
  //       return err;
  //     });
  //   })
  //   .then(console.log("okay"));
  jsonexport(exports.found, (err, csvstring) => {
    if (err) {
  ...
  // Promise.all([jsoncsv(exports.found), saveDialog(opts, (filename) => {
  //   // return new Promise((resolve, reject) => {
  //   // resolve(filename);
  //   return filename;
  //   // });
  ...
  //     console.log(csvstring);
  //     return writeFile(filename, csvstring);
  //   })
  ...
  // Promise.all([saveDialog(opts), jsoncsv(exports.found)])
  //   // .resolve()
  //   .catch((err) => {
  //     console.log(err.stack);
  //   })
  //   .spread(writeFile)
  //   .then(() => {console.log("okay");});
  // return Promise.join(saveDialog(opts), jsoncsv(exports.found), (filename, csvstring) => {
  //   // return new Promise.spread(filename, csvstring);
  //   console.log(filename);
  //   console.log(csvstring);
  // });
    // Do the above two promises, then pass the output to writeFile.
    // (filename, csvString) => {
      // return writeFile(filename, csvString)
      //   .catch((err) => {
      //     console.log(err.stack);
      //     // reject(err, "Could not save data");
      //   });
    // })
    // );
    // .catch(throw)
...
exports.toJSONFile = function() {
  ...
  saveDialog(options)
    .then((filename) => {
      return writeJSON(filename, exports.found);
    })
    .then(console.log(`Data saved.`))
    .catch((err) => {
      console.log(err.stack);
