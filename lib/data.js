...
exports.makeQueryRow = function() {
  let $row = $("<div />", {"class": "card grey darken-4"});
  ...
  let $searchDiv = $("<div />", {"class": "form-group input-field grey darken-4"});
  $searchDiv.append($("<label />", {
    "text": "Search for:"
  }))
    .append($("<input />", {
      "name": "query",
      "class": "form-control grey darken-4",
      "type": "text"
    }));
  $row.append($fieldDiv)
    .append($searchDiv);
