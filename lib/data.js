...
exports.dataHTML = `
    <table>
    <th><h2>Data</h2></th>
    <tr><td><button class="btn btn-large btn-positive" onclick=dataProc.combineData(dataProc.viewData())>View data...</button></td>
    <td><button class="btn btn-large btn-positive" onclick=dataProc.combineData(dataProc.toCSV())>Export data...</button></td></tr>
    </table>`;
