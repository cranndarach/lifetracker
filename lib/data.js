...
function getHeaders() {
  // Get the set of unique keys from the filtered data.
  return _.uniq(_.flatten(_.map(exports.found, _.keys)));
}
...
function displayData() {
  let $table = $("<table />", {
    "id": "data-table",
    "class": "data-display-table"
  })
    .append(makeTableHeader(getHeaders()))
    .append($("<tbody />"));
  $("#data-display").html("")
    .append($table)
    .ready(() => {
