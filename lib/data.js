...
function formatDates(data) {
  ...
  let dateTypes = ["start", "end", "when"];
  return _.map(data, (entry) => {
    _.forEach(dateTypes, (type) => {
      if (entry[type]) {
        entry[type] = moment(entry[type]).format(fmt);
      }
    });
    return entry;
  });
...
exports.displayData = function() {
  ...
  let $table = $("<table />", {
    "id": "data-table",
    "class": "data-display-table highlight striped responsive-table"
  })
