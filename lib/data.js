...
exports.buttons = `
  <table>
    <tr>
      <td>
        <button class="btn btn-large btn-positive" onclick=dataProc.toCSV("found")>
          Export to CSV...
        </button>
      </td>
      <td>
...
exports.makeQueryRow = function() {
  var html = `<fieldset>
      ...
      <select class="form-control" multiple class="fields">
        ${exports.fieldSelect}
      </select>
...
exports.searchHTML = function() {
  ...
  <div id="access-data" class="form">
    ...
    <button class="btn btn-form btn-positive" onclick=dataProc.toCSV("all")>
...
exports.getCategories = function() {
  ...
  exports.data.forEach((entry) => {
    ...
    if (!arrMember.member(exports.categories, cat)) {
