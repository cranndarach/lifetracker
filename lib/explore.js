...
function opsButtons(entry) {
  ...
  let deleteBtn = `<button class="btn-flat table-btn" onclick="dataProc.confirmDelete('${entry.uuid}')">`;
...
function initDynatable() {
  ...
  let records = exports.getRecords();
  $("#data-table")
    ...
    .dynatable({
      ...
      // inputs: {
      //   processingText: "<div class='progress'><div class='indeterminate'></div></div>"
      // }
    });
}
