...
function opsButtons(entry) {
  ...
  let editBtn = `<button class="btn-flat table-btn" click=edit.edit("${entry.uuid}")>`;
  let editIcon = "<i class='material-icons'>edit</i>";
  let deleteBtn = `<button class="btn-flat table-btn" click=console.log("delete", ${entry.uuid})>`;
